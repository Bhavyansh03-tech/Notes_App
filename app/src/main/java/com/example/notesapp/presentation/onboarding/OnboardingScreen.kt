package com.example.notesapp.presentation.onboarding
...
import com.example.notesapp.common.IconButton
import com.example.notesapp.common.PageIndicator
import com.example.notesapp.presentation.onboarding.components.OnboardingPage
import com.example.notesapp.presentation.onboarding.model.pages
import com.example.notesapp.presentation.onboarding.viewModel.OnBoardingEvents
import com.example.notesapp.util.Dimens.MEDIUM_PADDING2
import com.example.notesapp.util.Dimens.PAGE_INDICATOR_WIDTH
...
fun OnBoardingScreen(
    ...
    Column(
        ...
        Row(
            ...
            PageIndicator(
                modifier = Modifier.width(PAGE_INDICATOR_WIDTH), // Change
                pageSize = pages.size,
